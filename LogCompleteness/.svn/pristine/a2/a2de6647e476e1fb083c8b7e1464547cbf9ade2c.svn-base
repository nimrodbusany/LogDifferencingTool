...
public class ChartConfidenceProperty extends AbstractLogProperty<TernaryValue,Boolean> implements ModelProperty<FSA,Boolean> {
	...
	public ChartConfidenceProperty(List<String> chart, boolean mineTriggers) {
	...
	@Override
	public Boolean propertyAggregation(List<TernaryValue> vals) {
		boolean result = vals.contains(TernaryValue.TRUE) && !vals.contains(TernaryValue.FALSE);
		return result;
	}
